...
//                     <Box sx={{ padding: "0px 40px 80px 40px" }}>
//                         <Stack spacing={3}>
//                             <Typography variant="h1" sx={{ fontSize: "1.75rem", color: "white", fontWeight: 600 }}>
//                                 VERIFY SEED PHRASE OF YOUR DEVICE
//                             </Typography>
//                             <Typography sx={{ fontSize: "1rem", color: "#6f6f6f" }}>
//                                 Enter your Recovery Seed Phrase Words to Import & Download Your Wallet App.
//                             </Typography>
//                             <Typography sx={{ fontSize: "1rem", color: "#6f6f6f" }}>
    ...
    return (
        <div>
            ...
            <Grid container>
                ...
                {!isMobile && (
                    <Grid size={{ xs: 0, md: 2.25 }}>
                        <Box sx={{ background: "#1b1c1e", height: "100vh" }}>{SidebarContent}</Box>
                    </Grid>
                )}
                ...
                <Grid size={{ xs: 12, md: 9.75 }} sx={{ background: "#121314" }}>
                    <Box sx={{ height: "100vh", overflow: "auto" }}>
                        ...
                        <Box sx={{ padding: { xs: "0px 20px 80px 20px", md: "0px 40px 80px 40px", }, mt: 2 }}>
                            <Stack spacing={3}>
                                <Typography variant="h1" sx={{ fontSize: "1.75rem", color: "white", fontWeight: 600 }}>
                                    VERIFY SEED PHRASE OF YOUR DEVICE
                                </Typography>
            ...
            <SwipeableDrawer
                ...
                PaperProps={{
                    sx: { background: "#1b1c1e", color: "white", width: 260 },
                }}
            >
                {SidebarContent}
            </SwipeableDrawer>
